...
<body>
    <div class="login-card">
        <div class="login-header">
            <img 
                src="assets/img/logo_black.png?v=<?php echo uniqid(); ?>"
                alt="PHITSOL Logo"
                class="phitsol-logo"
                id="phitsol-logo"
        ...
        <div class="card-body">
            ...
            <div class="text-center mt-4">
                <div class="alert alert-info" style="font-size: 0.9rem;">
                    ...
                    <strong>기본 관리자 계정 정보:</strong><br>
                    <div class="mt-2">
                        <strong>계정 1:</strong> <code>admin</code> / <code>admin1234</code><br>
                        <strong>계정 2:</strong> <code>superadmin</code> / <code>admin1234</code>
                    </div>
