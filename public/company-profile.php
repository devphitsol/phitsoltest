...
<body>
            ...
            <div class="header-right">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <div class="user-name"><?php echo htmlspecialchars($user['name'] ?? $user['company_name']); ?></div>
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="summary-card stat-card">
                        ...
                        <div class="summary-content stat-content">
                            <h3 class="stat-number"><?php echo $status; ?></h3>
                ...
                <div class="col-md-3">
                    <div class="summary-card stat-card">
                        ...
                        <div class="summary-content stat-content">
                            <h3 class="stat-number"><?php echo count(array_filter($documents, function($doc) { return $doc; })); ?></h3>
                ...
                <div class="col-md-3">
                    <div class="summary-card stat-card">
                        ...
                        <div class="summary-content stat-content">
                            <h3 class="stat-number"><?php echo $lastLogin; ?></h3>
                ...
                <div class="col-md-3">
                    <div class="summary-card stat-card">
                        ...
                        <div class="summary-content stat-content">
                            <h3 class="stat-number"><?php echo isset($user['created_at']) ? (is_object($user['created_at']) ? $user['created_at']->toDateTime()->format('M Y') : date('M Y', strtotime($user['created_at']))) : 'N/A'; ?></h3>
    ...
    <script src="assets/js/partners-layout.js?v=<?php echo time(); ?>"></script>
</body>
</html> 