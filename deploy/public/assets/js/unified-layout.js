...
class ModernUnifiedLayout {
    ...
    setupHomeLinkInteractions() {
        ...
        this.setupHeaderHomeLinkInteractions();
    ...
    setupHeaderHomeLinkInteractions() {
        ...
        if (headerHomeLink) {
            ...
            headerHomeLink.addEventListener('click', (e) => {
                // Add ripple effect
                this.createRippleEffect(e, headerHomeLink);
                
                // Add pulse animation
                headerHomeLink.style.animation = 'pulse 0.6s ease-in-out';
                setTimeout(() => {
                    headerHomeLink.style.animation = '';
                }, 600);
            });
            
            // Add keyboard support
            headerHomeLink.addEventListener('keydown', (e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                    e.preventDefault();
            ...
            // Make header home link focusable
            headerHomeLink.setAttribute('tabindex', '0');
            headerHomeLink.setAttribute('role', 'button');
        }
    }
