...
class BlogController
{
    ...
    {
        return $this->blogModel->getPublished($limit, $offset);
    }
    ...
    {
        return $this->blogModel->getBySlug($slug);
    }
    ...
    {
        $uploadDir = __DIR__ . '/../../public/uploads/blog/videos/';
    ...
    {
        $imagePath = __DIR__ . '/../../public/uploads/blog/' . $filename;
    ...
    {
        $videoPath = __DIR__ . '/../../public/uploads/blog/videos/' . $filename;
